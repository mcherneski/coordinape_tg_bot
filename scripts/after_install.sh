...
echo 'cd /home/ec2-user/coordinape_bot' >> /home/ec2-user/coordinape_bot_logs/deploy.log
cd /home/ec2-user/coordinape_bot >> /home/ec2-user/coordinape_bot_logs/deploy.log
